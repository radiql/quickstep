...
The RADiQL QuickStep Framework represents a revolutionary step forward in Agile development capability that we call Ultra Agile (UA). It builds upon the work of Ivar Jacobson, Alistair Cockburn, Robert C Martin, Paul Morrison, Henri Bergius and Eric Evans. So although the RADiQL Quickstep Framework marks a revolutionary step forward, as with almost all progress in the field of science and technology, this revolutionary step is built on the shoulders of giants, and the solid foundations, hard work and wisdom of others after many years of practical experience and discovering good practice from the failures and difficulties that have been encountered. 

### Building on familiar concepts - a natural evolution of existing thought

RADiQL QuickStep is a revolutionary step forward in that it treats User Stories and Use Cases as first class components, combines Event Sourcing and highly concurrent programming techniques to fully leverage the power of the latest generation and future generations of microprocessors, does so with an easily understandable visual programming paradigm based upon event flows and integrates smoothly with existing tools, repositories and agile processes that are already very familiar to software developers and technology managers. However, each technology or process or paradigm that RADiQL QuickStep builds upon is already well established and, when seen in this way, RADiQL Quickstep merely represents a logical evolution of these. The revolutionary nature of RADiQL QuickStep is in the way that it combines these various elements in order to achieve an order of magnitude improvement in developer productivity, cost reduction and business agility. The true revolutionary nature of RADiQL QuickStep is that it radically changes our perception of how software should be developed. RADiQL QuickStep is so named because it represents a radical step forward in our understanding of how to specify, build and maintain dreliable and highly performant software.

### RADiQL QuickStep - combining concepts you already know of and understand

RADiQL QuickStep combines Use Cases (Jacobson), Flow Based Programming (Morrison/Bergius), Clean Architecture (Martin), Hexagonal Architecture (Cockburn), Domain Driven Design and Event Sourcing (Eric Evans) in an intuitive, highly visual data-driven framework that takes advantage of the latest advances in cloud technology, microservice technology, serverless technology, multi-core CPUs and crypto technologies such as Blockchain and Hashgraphs. What marks RADiQL as different is its ease of us, conceptual simplicity and low bar for entry, with application software being entirely unaware of the framework that underpins it. What makes it powerful is that its completely oriented to the direction that technology, government and commerce are taking in a way that other development tools are not. Be in no doubt: RADiQL is a next generation development tool suite and QuickStep is the means of defining next generation software components.

As previously mentioned, the underpinnings of all of this are well established and well understood. RADiQL and QuickStep merely draw all of these various threads of thought together to create an environment in which they can be combined successfully and compliment one another harmoniously. AppStratums implementation of RADiQL was names Harmony for this reason.

### Lowcode and Nocode based upon reusuable Stories
...
### Rapid Digital Transformation: Technology & Organisation
...
### Treating Collections of Stories as a reusable Component Library
